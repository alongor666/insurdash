...
*   **流程核心**:
    1.  **发现问题**: 在 GitHub Issues 中记录和追踪问题的解决过程。
    2.  **解决问题**: 提交的 Pull Request 必须关联对应的 Issue。
    3.  **沉淀知识**: 问题解决并验证后，由负责人按照标准模板，在 `/docs/issue-kb/` 目录下创建或更新对应的 `.md` 文档。
*   **详细规范**: 关于问题记录的**统一模板、标签系统、和具体操作流程**，请参考知识库的入口文档：[**`/docs/issue-kb/README.md`**](./docs/issue-kb/README.md)。

这套“活文档”体系确保了我们的知识沉淀与项目代码完全同步，为持续的质量改进提供了坚实的基础。
