...
为了系统性地提升项目质量、沉淀解决问题的经验，本项目建立了一套标准的问题追踪与知识库流程。我们相信，每一次测试发现的问题都应被结构化地记录、复盘和分享，从而实现团队的“真正吸收、持续进步”。

该流程的核心思想、模板、以及操作指南，都已沉淀为项目内的“活文档”。

**详情请参见**: [问题追踪与知识库流程文档](/docs/issue-kb/README.md)
